...
def generate(output_path, base_path, class_name, dataset_path):
    # Reseed
    ...
    module = __import__(f"{base_path}.{class_name}", fromlist=[class_name])
...
if __name__ == "__main__":
    output_path = "outputs_simple/Q_Merge_25Percent_Mean"
    base_path = "Models_simple"
    class_name = "Q_Merge_25Percent_Mean"
